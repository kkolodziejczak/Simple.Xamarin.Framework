...
namespace SXF.Core.ViewModels
{
    public class BaseViewModel : INotifyPropertyChanged
    {
        ...
        protected void SetValue(object value, [CallerMemberName]string name = null)
        {
            ...
            RisePropertyChange(name);
        }

        
        /// <summary>
        /// Recursive call OnPropertyChange for all dependencies of <see cref="name"/> property
        /// </summary>
        /// <param name="name"></param>
        private void RisePropertyChange(string name)
        {
